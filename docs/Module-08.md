...
makemigrations model changes ki migration file create karta hai, jabki migrate un changes ko database me apply karta hai.
...
GET generally data retrieve karne ke liye aur POST data submit/create karne ke liye use hota hai.
...
Bootstrap me col-md-6 medium aur larger screens par 12 columns me se 6 columns ki width leta hai.
...
**Ye final Module-08 documentation format hai bhai.** Isko direct `docs/Mo